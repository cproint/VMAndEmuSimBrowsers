...
This framework demonstrates Sauce Labs platform can run parallel tests using browser on VM, browser on Emulators, and browsers on Simulators within same build. However, note that this framework conforms to non-w3c standards.  
